...
class CustomDatasetFolder(VisionDataset):
    ...
    def __init__(self, root, loader, extensions=None, transform=None, target_transform=None, is_valid_file=None):
        ...
        samples = make_custom_dataset(self.root, '../classification/robustbench/data/imagenet_test_image_ids.txt',
                                      '../classification/robustbench/data/imagenet_class_to_id_map.json')
        if len(samples) == 0:
